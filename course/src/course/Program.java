...
public class Program {
	...
	public static void main(String[] args) throws ParseException {
		...
		while(out != true) {
			...
			System.out.println("[2] Remover Sessao"); //remove N sessoes de uma sala específica
			System.out.println("[3] Alterar Sessao"); //altera N sessoes de uma sala específica
			System.out.println("[4] Comprar Ingresso"); //compra N ingressos apos uma procura nas salas e sessoes
			System.out.println("[5] Iniciar Sessao"); //altera N sessoes de uma sala específica
			...
			switch(opcao) {
				case 1:
					...
					System.out.print("Em quantas sessoes o filme será exibido?: ");
